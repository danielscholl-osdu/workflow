...
public class AWSCognitoClient {
  public static String getTokenForUserWithAccess(){
    ...
    String authFlow = System.getenv("AWS_COGNITO_AUTH_FLOW");
    Map<String, String> authParameters = new HashMap<>();
    authParameters.put("USERNAME", System.getenv("AWS_COGNITO_AUTH_PARAMS_USER"));
    authParameters.put("PASSWORD", System.getenv("AWS_COGNITO_AUTH_PARAMS_PASSWORD"));
  ...
  public static String getTokenForUserWithNoAccess(){
    ...
    String authFlow = System.getenv("AWS_COGNITO_AUTH_FLOW");
    Map<String, String> authParameters = new HashMap<>();
    authParameters.put("USERNAME", System.getenv("AWS_COGNITO_AUTH_PARAMS_USER_NO_ACCESS"));
    authParameters.put("PASSWORD", System.getenv("AWS_COGNITO_AUTH_PARAMS_PASSWORD"));
